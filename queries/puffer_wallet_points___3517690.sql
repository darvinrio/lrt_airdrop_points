...
-- query name: puffer_wallet_points
-- query link: https://dune.com/queries/3517690
...
aggregated as (
    select 
        wallet,
        sum(amt_cumulative*earning_seconds*multiplier*30/(60*60)) as total_pearl_points,
        sum(
